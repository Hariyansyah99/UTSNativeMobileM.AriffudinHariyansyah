...
class PahlawanAdapter(private val context: Context, private val pahlawan : List<Pahlawan>, val listener:
    (Pahlawan) -> Unit) : RecyclerView.Adapter<PahlawanAdapter.PahlawanViewHolder>(){
